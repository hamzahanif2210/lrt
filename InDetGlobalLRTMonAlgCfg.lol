...
def InDetGlobalLRTMonAlgCfg(helper, alg, **kwargs):
	...
	lrtGroup.defineHistogram(varName, type='TH1F', path=pathlrt, title=title, xbins=m_trackBin, xmin=0.5, xmax=m_trackMax + 0.5)
	...
	lrtGroup.defineHistogram(varName, type='TH2F', path=pathlrt, title=title, xbins=m_nBinsEta, xmin=-m_c_etaRange, xmax=m_c_etaRange, ybins=m_nBinsPhi, ymin=-M_PI, ymax=M_PI)
	...
	lrtGroup.defineHistogram(varName, type='TProfile2D', path=pathlrt, title=title, xbins=m_nBinsEta, xmin=-m_c_etaRange, xmax=m_c_etaRange, ybins=m_nBinsPhi, ymin=-M_PI, ymax=M_PI)
	...
	lrtGroup.defineHistogram(varName, type='TProfile2D', path=pathlrt, title=title, xbins=20, xmin=-m_c_etaRangeTRT, xmax=m_c_etaRangeTRT, ybins=m_nBinsPhi, ymin=-M_PI, ymax=M_PI)
	...
	lrtGroup.defineHistogram(varName, type='TProfile', path=pathlrt, title=title, xbins=m_c_range_LB, xmin=0, xmax=m_c_range_LB)
