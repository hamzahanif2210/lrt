...
#LRT
  ...
  from InDetGlobalMonitoring.InDetGlobalMonitoringConf import InDetGlobalLRTMonTool
  InDetGlobalLRTMonTool=InDetGlobalLRTMonTool( name          = "InDetGlobalLRTMonTool",
                                                   histoPathBase = "/GLOBAL",
                                                   DoIBL         = InDetFlags.doIBL(),
                                                   trackMax      = 75,
                                                   TrackToVertexIPEstimator = TrackingCommon.getTrackToVertexIPEstimator() )
  ...
  InDetGlobalLRTMonTool.Baseline_SelTool = InDetTrackSelectionToolGlobalMon_Baseline
  InDetGlobalLRTMonTool.Tight_SelTool = InDetTrackSelectionToolGlobalMon_TightPrimary

  if DQMonFlags.monManDataType == 'heavyioncollisions' or InDetFlags.doHeavyIon() == True:
    InDetGlobalLRTMonTool.trackMax      = 10000
    InDetGlobalLRTMonTool.trackBin      = 1000
    
  if jobproperties.Beam.beamType()=='cosmics':
    InDetGlobalLRTMonTool.trackMax = 10
    InDetGlobalLRTMonTool.trackBin = 10

  if jobproperties.Beam.beamType()=='collisions':
    from AthenaMonitoring.FilledBunchFilterTool import GetFilledBunchFilterTool
    InDetGlobalLRTMonTool.FilterTools += [GetFilledBunchFilterTool()]
      
  #ToolSvc += InDetGlobalLRTMonTool
  if (InDetFlags.doPrintConfigurables()):
      printfunc (InDetGlobalLRTMonTool)
...
if InDetFlags.doMonitoringGlobal():
  ...
  if (InDetFlags.doPrintConfigurables()):
      printfunc (InDetGlobalManager)InDetMonitoringGlobal.py
